...
function fileDialogComplete(numFilesSelected, numFilesQueued) {
	...
	pic_num = $("#thumbnails img").length;
	if(pic_num > this.settings.file_upload_limit || pic_num + numFilesSelected > this.settings.file_upload_limit){
		alert('上传文件数量超出限制');
		return;
	}
	try {

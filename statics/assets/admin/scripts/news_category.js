AM.news_category = {
    ...
    loadLists : function(){
        this.table = $('#item_list').DataTable({
            ajax: {
                //指定数据源
                url: admin_url+"news_category/getlist"
            },
            language: {
                "search": "过滤记录:",
    ...
    editItem : function(id){
        ...
        that.loading('show');
        $.ajax({
            "url":admin_url+"news_category/getinfo",
            "data":{id:id},
            "dataType":"json",
            "type":"POST",
    ...
    delItem : function(ids){
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                ...
                that.loading('show');
                $.ajax({
                    "url":admin_url+"news_category/del",
                    "data":{ids:ids},
                    "dataType":"json",
                    "type":"POST",
                    "success":function (rdata) {
    ...
    saveItem : function(){
        ...
        $.ajax({
            "url":admin_url+"news_category/save",
